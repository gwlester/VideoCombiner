...
parser.add_argument("-v", "--video-file", help="Source video file")
parser.add_argument("-a", "--audio-file", help="Source audio file to embed with the video")
...
parser.add_argument("-c", "--composite", help="Combine existing audio in the video with new audio (only use if video has audio)", action="store_true", default=False)
...
parser.add_argument("-o", "--output-file", default="merged.mpr", help="Combined file")
